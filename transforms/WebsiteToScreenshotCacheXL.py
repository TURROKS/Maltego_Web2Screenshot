...
def api_handler(api_url, target_url, api):
    ...
    data = requests.get(api_url+f"urltoimage?access_key={api}&url=https://{target_url}&full_page=true")
...
@registry.register_transform(display_name="To Screenshot XL - Cache [API Flash]", input_entity="maltego.Website",
                             description='Take a cache full page screenshot from an Website, will consume 1 credit if '
